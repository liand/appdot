package org.appdot.archetypes.integration.gui;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

import org.appdot.archetypes.entity.account.Task;
import org.appdot.archetypes.entity.data.TaskData;
...
public class TaskGuiIT extends BaseSeleniumTestCase {
	...
	public void inputInValidateValue() {
		...
		assertEquals("必选字段", selenium2.getText(By.xpath("//fieldset/div[1]/span")));
	}
