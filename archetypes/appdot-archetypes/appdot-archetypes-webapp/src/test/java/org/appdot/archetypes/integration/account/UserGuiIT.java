package org.appdot.archetypes.integration.account;
...
import org.appdot.archetypes.integration.BaseSeleniumTestCase;
import org.appdot.archetypes.integration.Gui;
import org.appdot.archetypes.integration.Gui.UserColumn;
...
public class UserGuiIT extends BaseSeleniumTestCase {
	...
	public void inputInValidateUser() {
		...
		assertEquals("用户登录名已存在", selenium2.getText(By.xpath("//*[@id=\"inputForm\"]/fieldset/div[2]/span")));
		assertEquals("必选字段", selenium2.getText(By.xpath("//*[@id=\"inputForm\"]/fieldset/div[3]/span")));
		assertEquals("输入与上面相同的密码", selenium2.getText(By.xpath("//fieldset/div[5]/span")));
